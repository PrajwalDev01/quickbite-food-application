...
public class Restaurant {
	...
	public Restaurant(String name, String cuisineType, int deliveryTime, String address, double rating,
	...
	public boolean getIsActive() { // matching is naming style or standard isActive
		return isActive;
	}
